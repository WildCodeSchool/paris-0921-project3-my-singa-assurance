        ...
        <div className={style.textActus}>
          ...
          <div className={style.engagementContainer}>
            ...
            <p className={style.engagementdescription}>
              Singa prélève des frais fixe, et considère que le reste de votre cotisation est le vôtre, et non le nôtre. Nous utilisons vos
              cotisations pour remboursere vos frais de santé, et redistribuons l&apos;argent qui reste à des causes qui vous tiennent à coeur.
            </p>
          </div>
          <div className={style.explications}>
            ...
            <ul className={style.explicationsTable}>
              ...
              <li>
                L&apos;engagement social est au cœur de notre business model. C&apos;est pourquoi Lemonade Inc. est une société d&apos;intérêt public
                et certifiée B-Corp.
              </li>
            </ul>
          </div>
